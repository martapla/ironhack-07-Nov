...
document.getElementById('insert-p').appendixChild(createElement1);

// 2º - Crea un <div id="nested"></div> desde código

const createElement2 = document.createElement("div");
createElement2.setAttribute('id', 'nested')
document.querySelector('body').appendixChild(createElement2);
...
// const addFunction = () => newButton.classList.add("button");
// newButton.addEventListener("click", addFunction);
