...
<template>
  ...
  <div class="ex1">
    <ol>
        ...
        <li v-for="(peli,index) in pelis" :key="index">
        {{index + 1}} - {{peli}}
        </li>
    ...
    <div class="ex2">
        <ul>
            <li v-for="(favourite,index) in favs" :key="index">
            <div>
                <h4> Favourite food: {{favoriteFood}}</h4>
                <h4> Favourite drink: {{favoriteDrink}}</h4>
            </div>
            </li>
        </ul>
